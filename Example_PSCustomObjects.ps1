<#
    ...
    .notes
        ...
        https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_pscustomobject?view=powershell-5.1
    .example
        PS> .\Example_PSCustomObjects.ps1
#>
